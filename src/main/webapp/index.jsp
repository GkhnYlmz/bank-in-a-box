        ...
        <div>
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div id="logo-group">
                            <span id="logo"><a href="/InternetBankingHost/"><img src="" alt="Jengabank"></a></span>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="item active">
                                <div class="carousel-caption ">
                                    <div class="textArea xs-txt-cnt  sm-txt-cnt md-txt-lf">
                                        <a href="https:///5817-guvenlik" target="_blank">
...
<div class="txt txt3">Detaylar için tıklayınız</div>
                            ...
                            <div class="item ">
                                <div class="carousel-caption ">
                                    <div class="textArea xs-txt-cnt  sm-txt-cnt md-txt-lf">
                                        <a href="https:///5825-nasil_uye_olabilirim" target="_blank">
...
<div class="container">
    ...
    <div class="link-group">
                <a href="/InternetBankingHost/HostLogin?lang=en-US" class="lang">
                    ...
                    <a target="_blank" href="https:///5651-sikca_sorulan_sorular">Sık&#231;a Sorulan Sorular</a>
                    <a href="https:///5675-sube_atm_arama" target="_blank">
                 ATM ve Şubeler
             </a>
                    <a target="_blank" href="https:///14891-planli_kesintiler">Duyurular</a>
    </div>
</div>
        </section>
        <section>
...
<div class="container login-box-area login-footer-area">
    <div class="row">
        ...
        <div class="col-md-3">
                ...
                <a target="_blank" href="https:///5659-mutlu_musteri_merkezi">
        ...
        <div class="col-md-3">
                <a target="_blank" href="https:///5817-guvenlik">
        ...
        <div class="col-md-3">
                ...
                <a target="_blank" href="">
                    <div class="box box2 text-align-center paraf-border">
                        <div class=""></div>
                        <span class="title">Jenga Card</span>
