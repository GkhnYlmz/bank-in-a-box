...
<div class="container">  
  <form id="contact" action="../EftIslem" method="post">
    ...
    <div align="left">
    <fieldset>
     <label style="color: #2B46F1;font-weight: bold;"> <b>Hesap Ismi: </b></label> <label> Gokcen KARASU - TL - Vadesiz
      </label>
      </fieldset>
      
      <fieldset>
       <label style="color: #2B46F1;font-weight: bold;"> <b>Bakiye: </b></label> <label> 150.000 TL</label>
    </fieldset>
